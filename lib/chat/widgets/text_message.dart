...
class TextMessage extends StatelessWidget {
  ...
  Widget _linkPreview(
    ...
    return LinkPreview(
      ...
      linkStyle: const TextStyle(color: kColorDarkGreen),// bodyLinkTextStyle ?? bodyTextStyle,
      ...
      previewData: null,// message.previewData,
      text: message.text,
      textStyle:TextStyle(color: kColorDarkGreen),// bodyTextStyle,
      width: width,
    );
  }
    ...
    return Column(
      ...
      children: [
        ...
        SelectableText(
          message.text,
          style:TextStyle(
                color: currentUserIsAuthor ? kColorDarkGreen : Colors.white,
                fontSize: 14,
