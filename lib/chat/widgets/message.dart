            ...
            : Container(
                decoration: BoxDecoration(
                    ...
                    color: !currentUserIsAuthor ||
                        ...
                        ? kColorDarkGreen //InheritedChatTheme.of(context).theme.secondaryColor
                        : Color(
                            0xffeaf2fe) //InheritedChatTheme.of(context).theme.primaryColor,
                    ),
                child: ClipRRect(
                  borderRadius: borderRadius,
  ...
  Widget _statusBuilder(BuildContext context) {
    switch (message.status) {
      ...
      case types.Status.seen:
        return Container();
        // InheritedChatTheme.of(context).theme.seenIcon != null
