...
import 'package:bridgemetherapist/chat/widgets/inherited_l10n.dart';
...
class Chat extends StatefulWidget {
  ...
  const Chat({
    ...
    this.showSessionNotes = true,
    this.showScreeningTools = true,
    this.onSessionNotesTapped,
    this.onScreenToolsTapped,
  ...
  final bool showSessionNotes;
  final bool showScreeningTools;
  final Function? onSessionNotesTapped;
  final Function? onScreenToolsTapped;
                    ...
                    if (widget.showSessionNotes) ...[
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: InkWell(
                            onTap: () {
                              if (widget.onSessionNotesTapped != null) {
                                widget.onSessionNotesTapped!();
                              }
                            },
                            child: const Card(
                              child: ListTile(
                    ...
                    if (widget.showScreeningTools) ...[
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: InkWell(
                            onTap: () {
                              if (widget.onScreenToolsTapped != null) {
                                widget.onScreenToolsTapped!();
                              }
                            },
                            child: const Card(
                              child: ListTile(
                                title: Text("Administer screening tool"),
                                trailing: Icon(
